  ...
  return (0, _utils.compose)(pojo, function (blob) {
    ...
    if (fieldsWithErrors.length > 0 || missing.size > 0) {
      ...
      if (fieldsWithErrors.length > 0) {
        ...
        _err = (0, _debrief.annotateFields)(blob, errorlist);
      } else {
        _err = (0, _debrief.annotate)(blob);
      }
      ...
      if (missing.size > 0) {
        ...
        _err = (0, _debrief.annotate)(_err, "Missing ".concat(pluralized, ": ").concat(errMsg));
      }

      return (0, _Result.Err)(_err);
    }
